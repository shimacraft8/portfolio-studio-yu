...
| line | #e0e3e6 | 罫線 |
| gold | #f0b429 | シグナルカラー。CTA・おすすめバッジ・キャンペーン・チェック・統計数字のみ |
| gold-deep | #c88a00 | 白背景上のゴールド文字（0円・おすすめプランの単価等） |

ゴールドの使用ルール: 「行動（CTA）・お得（0円/キャンペーン）・おすすめ・小さな道標
（チェック/バー/ドット）」に限定。本文・見出しはモノトーンのまま。
